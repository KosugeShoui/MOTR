...
from engine import evaluate, train_one_epoch, train_one_epoch_mot, multiply_loss_giou_values, sigmoid_base_sche
from models import build_model
from tqdm import tqdm
from util.learning_curve_each import plot_combined_loss
from util.learning_unscaled_curve_each import plot_combined_unscaled_loss
from util.learning_curve import plot_learning_curve
...
def get_args_parser():
    ...
    parser.add_argument('--final_weight', default=1, type=float)
    ...
    parser.add_argument('--val_width', default=480, type=int)
...
def main(args):
    ...
    if args.dataset_file in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint','e2e_visem']:
    ...
    for epoch in tqdm(range(args.start_epoch, args.epochs)):
        ...
        #each epoch learning curve save
        #train loss score get
        ...
        if args.output_dir:
            ...
            checkpoint_paths = [output_dir / 'best_weight_ep{}.pth'.format(epoch+1)]
            print('\nbest path update\n')
        ...
        if args.dataset_file not in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint','e2e_visem']:
        ...
        plot_learning_curve(args.output_dir)
